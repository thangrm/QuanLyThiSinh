 ...
 */
public class fXacNhanXoaTaiKhoan extends Dialog {
    ...
    public fXacNhanXoaTaiKhoan(fHome owner, String username) {
        super(owner, "Xác nhận", true);
        this.messager = "Bạn có muốn xóa tài khoản " + username + " không";
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i = 0; i < n; i++) {
                    if (username.equals(listTaiKhoan.get(i).getUsername())) {
                        ...
                        home.tbTaiKhoan.removeRowSelected();
                        break;
                    }
                }
                dispose();
